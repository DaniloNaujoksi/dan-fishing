...
enum FishCatalog {
    ...
    static let all: [FishSpecies] = [
        ...
        FishSpecies(
            ...
            rarity: .uncommon,
            feeding: .peaceful,
            minLength: 22, maxLength: 58,
            minWeight: 0.15, maxWeight: 2.4,
        ...
        FishSpecies(
            ...
            rarity: .rare,
            feeding: .peaceful,
            minLength: 30, maxLength: 92,
            minWeight: 0.5, maxWeight: 8.5,
        ...
        FishSpecies(
            id: "sturgeon",
            name: "Stör",
            summary: "Ein Fisch aus einer anderen Zeit: Knochenplatten statt Schuppen, spitze Schnauze, Barteln am Grund. Selten und uralt.",
            rarity: .veryRare,
            feeding: .omnivore,
            minLength: 70, maxLength: 195,
            minWeight: 3.0, maxWeight: 48.0,
